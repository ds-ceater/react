        ...
        <section>
          <div className="section">
            <div className="section_inner">
              <h1 className={`${ZenOldMincho.className} ${"section_ttl"}`}>コマースメディア株式会社 コーポレートサイト</h1>
              <div className="detail_info">
                <dl className="info_list">
                  <dt className="info_ttl">Type:</dt>
                  <dd className="info_item">Illustration</dd>
                </dl>
                <dl className="info_list">
                  <dt className="info_ttl">Launch Date:</dt>
                  <dd className="info_item">2020.5</dd>
                </dl>
                <Link href="https://commerce-media.info/pages/aboutus" className="btn info_item-link" target='_blank' rel='noopener'>
                      VIEW SITE
                    </Link>
              </div>
              <div className="detail_mock">
                <Image
                  src="/images/commerce illust.png"
                  width={1280}
                  height={896}
              ...
              <p className="detail_comment">ECサイト運営・コンサルティング企業のコマースメディア株式会社のコーポレートサイトに使用するイラスト3枚を作成しました。</p>
              <div className="detail_desc">
                <div className="detail_box">
                  <h1 className="detail_box-ttl"><span className="detail_box-ttl-letter">ターゲット</span></h1>
                  <div className="detail_box-textWrap">
                  <p className="detail_box-text">コマースメディアに興味を持った求職者、取引先</p>
                  </div>
                </div>
                <div className="detail_box">
                ...
                <div className="detail_box">
                  ...
                  <div className="detail_box-textWrap">
                  <p className="detail_box-text">1週間</p>
                  </div>
                </div>
              </div>
