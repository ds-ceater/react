        ...
        <section>
          <div className="section">
            <div className="section_inner">
              <h1 className={`${ZenOldMincho.className} ${"section_ttl"}`}>天気検索アプリ</h1>
              <div className="detail_info">
                ...
                <Link href="https://ds-ceater.github.io/react-typescript-weather-app/" className="btn info_item-link" target='_blank' rel='noopener'>
                      VIEW SITE
                    </Link>
              </div>
              ...
              <div className="detail_desc">
                ...
                <div className="detail_box">
                  ...
                  <div className="detail_box-textWrap">
                  <p className="detail_box-text">3日</p>
                  </div>
                </div>
              </div>
